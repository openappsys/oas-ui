...
export { OASScrollArea } from './layout/scroll-area/oas-scroll-area.js'
...
// 能力包必须先于组件注册：customElements.define 会同步升级 DOM 中已有元素，元素构造时读能力注册表
...
export { OASSegmented, type SegmentedOption } from './form/segmented/index.js'
...
export { OASPopover } from './feedback/popover/oas-popover.js'
export { OASHoverCard } from './feedback/hover-card/oas-hover-card.js'
...
export {
  ...
  OASDropdownGroup,
  OASDropdownDivider,
} from './navigation/dropdown/index.js'
export {
  OASContextMenu,
  OASContextMenuItem,
  OASContextMenuGroup,
...
export {
  ...
  type NavItem,
} from './navigation/navigation-menu/index.js'
export {
  OASToolbar,
  OASToolbarToggle,
...
export { OASTabs, OASTabPanel } from './navigation/tabs/index.js'
...
// 能力包必须先于组件注册（同上）
import './data/table/edit/index.js'
...
export { OASImageGroup } from './data/image-group/oas-image-group.js'
...
export { OASThemeEditor } from './framework/theme-editor/index.js'
