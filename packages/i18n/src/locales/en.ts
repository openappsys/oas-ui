...
export const en: LocaleMessages = {
  ...
  'datePicker.join': ', ',
  'datePicker.shortcutToday': 'Today',
  ...
  'upload.maxCount': 'Up to {max} files',
  'upload.preview': 'Preview {name}',
  'upload.previewDialog': 'File preview',
  'upload.closePreview': 'Close preview',
  ...
  'transfer.noMatch': 'No matches found',
  ...
  'image.preview.flipX': 'Flip horizontal',
  'image.preview.flipY': 'Flip vertical',
  'image.preview.prev': 'Previous image',
  'image.preview.next': 'Next image',
  'image.preview.progress': 'Image {index} of {total}',
