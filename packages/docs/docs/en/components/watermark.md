...
| `opacity` | Watermark layer transparency (0–1, auto-clamped)   | `number`  | `0.15`  |
| `repeat`  | Boolean; when present the unit is tiled, otherwise a single unit is centered | `boolean` | `false` |
