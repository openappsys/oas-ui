...
<DemoBlock title="缎带形态">
  ...
  <oas-badge ribbon text="HOT" ribbon-form="rounded" style="margin-inline-end: var(--oas-space-4)">
    <oas-card><p>rounded（圆头）</p></oas-card>
  </oas-badge>
  <oas-badge ribbon text="HOT" ribbon-form="zigzag" style="margin-inline-end: var(--oas-space-4)">
    <oas-card><p>zigzag（锯齿）</p></oas-card>
  </oas-badge>
  <oas-badge ribbon text="HOT" ribbon-form="arrow" style="margin-inline-end: var(--oas-space-4)">
    <oas-card><p>arrow（箭头）</p></oas-card>
  </oas-badge>
