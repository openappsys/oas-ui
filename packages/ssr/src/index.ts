...
const TAG_ENTRY: Record<WhiteListTag, string> = {
  ...
  'oas-affix': '@oas-ui/ui/navigation/affix',
  'oas-ellipsis': '@oas-ui/ui/data/ellipsis',
  'oas-scroll-area': '@oas-ui/ui/layout/scroll-area',
  ...
  'oas-skeleton-item': '@oas-ui/ui/feedback/skeleton',
  ...
  'oas-masonry': '@oas-ui/ui/layout/masonry',
  ...
  'oas-aspect-ratio': '@oas-ui/ui/layout/aspect-ratio',
  'oas-virtual-list': '@oas-ui/ui/data/virtual-list',
  // —— DSD 批次 4：导航布局组件（layout 多 tag 目录一次装载注册全部） ——
  'oas-tabs': '@oas-ui/ui/navigation/tabs',
  'oas-tab-panel': '@oas-ui/ui/navigation/tabs',
  'oas-bottom-navigation': '@oas-ui/ui/navigation/bottom-navigation',
  'oas-pagination': '@oas-ui/ui/navigation/pagination',
  'oas-steps': '@oas-ui/ui/navigation/steps',
  'oas-segmented': '@oas-ui/ui/form/segmented',
  ...
  'oas-menu': '@oas-ui/ui/navigation/menu',
  'oas-dropdown': '@oas-ui/ui/navigation/dropdown',
  'oas-context-menu': '@oas-ui/ui/navigation/contextmenu',
  'oas-menubar': '@oas-ui/ui/navigation/menubar',
  'oas-navigation-menu': '@oas-ui/ui/navigation/navigation-menu',
  'oas-toolbar': '@oas-ui/ui/navigation/toolbar',
  'oas-command': '@oas-ui/ui/navigation/command',
  'oas-tour': '@oas-ui/ui/navigation/tour',
  'oas-hover-card': '@oas-ui/ui/feedback/hover-card',
  'oas-splitter': '@oas-ui/ui/layout/splitter',
  'oas-flex': '@oas-ui/ui/layout/flex',
  'oas-page-header': '@oas-ui/ui/navigation/page-header',
  'oas-float-button': '@oas-ui/ui/navigation/float-button',
  'oas-speed-dial': '@oas-ui/ui/navigation/speed-dial',
  ...
  'oas-tooltip': '@oas-ui/ui/feedback/tooltip',
